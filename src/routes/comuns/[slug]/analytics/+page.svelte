<script lang="ts">
  ...
  const copyByLanguage: Record<Language, Copy> = {
    ru: { pageTitle: 'Статистика сообщества', title: 'Статистика', back: 'В сообщество', today: 'Сегодня', week: '7 дней', month: '30 дней', views: 'Просмотры постов', comments: 'Комментарии', subscribers: 'Подписчики', current: 'Сейчас', gained: 'Новые', lost: 'Отписались', net: 'Изменение', activityTitle: 'Активность за 30 дней', activityDescription: 'Просмотры постов и новые комментарии по дням', subscribersTitle: 'Динамика подписчиков', subscribersDescription: 'Подписки и отписки по дням', loading: 'Загружаем статистику…', authRequired: 'Войдите в аккаунт администратора сообщества.', forbidden: 'Статистика доступна только создателю и модераторам сообщества.', loadError: 'Не удалось загрузить статистику.', collectionStarted: 'Точные просмотры и изменения подписчиков учитываются с' },
    en: { pageTitle: 'Community analytics', title: 'Analytics', back: 'Back to community', today: 'Today', week: '7 days', month: '30 days', views: 'Post views', comments: 'Comments', subscribers: 'Subscribers', current: 'Current', gained: 'Gained', lost: 'Lost', net: 'Net change', activityTitle: 'Activity over 30 days', activityDescription: 'Daily post views and new comments', subscribersTitle: 'Subscriber dynamics', subscribersDescription: 'Daily subscriptions and unsubscriptions', loading: 'Loading analytics…', authRequired: 'Sign in with a community administrator account.', forbidden: 'Analytics are available only to the community creator and moderators.', loadError: 'Could not load analytics.', collectionStarted: 'Accurate views and subscriber changes are tracked since' },
    de: { pageTitle: 'Community-Statistik', title: 'Statistik', back: 'Zur Community', today: 'Heute', week: '7 Tage', month: '30 Tage', views: 'Beitragsaufrufe', comments: 'Kommentare', subscribers: 'Abonnenten', current: 'Aktuell', gained: 'Neu', lost: 'Verloren', net: 'Veränderung', activityTitle: 'Aktivität der letzten 30 Tage', activityDescription: 'Tägliche Beitragsaufrufe und neue Kommentare', subscribersTitle: 'Abonnentenentwicklung', subscribersDescription: 'Tägliche Abonnements und Abmeldungen', loading: 'Statistik wird geladen…', authRequired: 'Melde dich mit einem Community-Administratorkonto an.', forbidden: 'Die Statistik ist nur für Ersteller und Moderatoren verfügbar.', loadError: 'Statistik konnte nicht geladen werden.', collectionStarted: 'Genaue Aufrufe und Abonnentenänderungen werden erfasst seit' },
    es: { pageTitle: 'Estadísticas de la comunidad', title: 'Estadísticas', back: 'Volver a la comunidad', today: 'Hoy', week: '7 días', month: '30 días', views: 'Vistas de publicaciones', comments: 'Comentarios', subscribers: 'Suscriptores', current: 'Actuales', gained: 'Nuevos', lost: 'Bajas', net: 'Cambio neto', activityTitle: 'Actividad de 30 días', activityDescription: 'Vistas y nuevos comentarios por día', subscribersTitle: 'Dinámica de suscriptores', subscribersDescription: 'Suscripciones y bajas por día', loading: 'Cargando estadísticas…', authRequired: 'Inicia sesión con una cuenta administradora.', forbidden: 'Las estadísticas solo están disponibles para el creador y los moderadores.', loadError: 'No se pudieron cargar las estadísticas.', collectionStarted: 'Las vistas exactas y los cambios de suscriptores se registran desde' },
    fr: { pageTitle: 'Statistiques de la communauté', title: 'Statistiques', back: 'Retour à la communauté', today: "Aujourd'hui", week: '7 jours', month: '30 jours', views: 'Vues des publications', comments: 'Commentaires', subscribers: 'Abonnés', current: 'Actuels', gained: 'Nouveaux', lost: 'Perdus', net: 'Variation nette', activityTitle: 'Activité sur 30 jours', activityDescription: 'Vues et nouveaux commentaires par jour', subscribersTitle: 'Évolution des abonnés', subscribersDescription: 'Abonnements et désabonnements par jour', loading: 'Chargement des statistiques…', authRequired: 'Connectez-vous avec un compte administrateur.', forbidden: 'Les statistiques sont réservées au créateur et aux modérateurs.', loadError: 'Impossible de charger les statistiques.', collectionStarted: 'Les vues précises et les changements d’abonnés sont suivis depuis le' },
    pt: { pageTitle: 'Estatísticas da comunidade', title: 'Estatísticas', back: 'Voltar à comunidade', today: 'Hoje', week: '7 dias', month: '30 dias', views: 'Visualizações dos posts', comments: 'Comentários', subscribers: 'Assinantes', current: 'Atuais', gained: 'Novos', lost: 'Perdidos', net: 'Variação líquida', activityTitle: 'Atividade em 30 dias', activityDescription: 'Visualizações e novos comentários por dia', subscribersTitle: 'Dinâmica de assinantes', subscribersDescription: 'Inscrições e cancelamentos por dia', loading: 'Carregando estatísticas…', authRequired: 'Entre com uma conta administradora da comunidade.', forbidden: 'As estatísticas estão disponíveis apenas para o criador e moderadores.', loadError: 'Não foi possível carregar as estatísticas.', collectionStarted: 'Visualizações exatas e mudanças de assinantes são registradas desde' },
    tr: { pageTitle: 'Topluluk istatistikleri', title: 'İstatistikler', back: 'Topluluğa dön', today: 'Bugün', week: '7 gün', month: '30 gün', views: 'Gönderi görüntülemeleri', comments: 'Yorumlar', subscribers: 'Aboneler', current: 'Mevcut', gained: 'Yeni', lost: 'Ayrılan', net: 'Net değişim', activityTitle: '30 günlük etkinlik', activityDescription: 'Günlük gönderi görüntülemeleri ve yeni yorumlar', subscribersTitle: 'Abone dinamikleri', subscribersDescription: 'Günlük abonelikler ve ayrılmalar', loading: 'İstatistikler yükleniyor…', authRequired: 'Topluluk yöneticisi hesabıyla giriş yapın.', forbidden: 'İstatistikler yalnızca topluluk sahibi ve moderatörler içindir.', loadError: 'İstatistikler yüklenemedi.', collectionStarted: 'Kesin görüntülemeler ve abone değişiklikleri şu tarihten itibaren izleniyor:' },
    id: { pageTitle: 'Statistik komunitas', title: 'Statistik', back: 'Kembali ke komunitas', today: 'Hari ini', week: '7 hari', month: '30 hari', views: 'Tampilan postingan', comments: 'Komentar', subscribers: 'Pelanggan', current: 'Saat ini', gained: 'Baru', lost: 'Berhenti', net: 'Perubahan bersih', activityTitle: 'Aktivitas 30 hari', activityDescription: 'Tampilan postingan dan komentar baru per hari', subscribersTitle: 'Dinamika pelanggan', subscribersDescription: 'Langganan dan berhenti berlangganan per hari', loading: 'Memuat statistik…', authRequired: 'Masuk dengan akun administrator komunitas.', forbidden: 'Statistik hanya tersedia untuk pembuat dan moderator komunitas.', loadError: 'Statistik tidak dapat dimuat.', collectionStarted: 'Tampilan akurat dan perubahan pelanggan dilacak sejak' },
  }
  ...
  let periodCards: Array<{ label: string; period: BackendComunAnalyticsPeriod }> = []
  ...
  $: periodCards = analytics
    ? [
        { label: copy.today, period: analytics.periods.day },
        { label: copy.week, period: analytics.periods.week },
        { label: copy.month, period: analytics.periods.month },
      ]
    : []
...
<main class="mx-auto w-full max-w-7xl px-4 py-5 sm:px-6 lg:px-8">
  ...
  {:else if analytics}
    ...
    <section class="grid border-b border-slate-200 dark:border-zinc-800 md:grid-cols-3">
      {#each periodCards as card, index}
        <div class={`py-5 md:px-6 ${index < 2 ? 'md:border-r md:border-slate-200 dark:md:border-zinc-800' : ''} ${index === 0 ? 'md:pl-0' : ''} ${index === 2 ? 'md:pr-0' : ''}`}>
          <h2 class="text-xs font-bold uppercase text-slate-500 dark:text-zinc-400">{card.label}</h2>
          <dl class="mt-4 space-y-3">
            {#each periodRows(card.period) as row}
