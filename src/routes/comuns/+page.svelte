...
<Modal bind:open={createOpen} on:close={resetForm}>
  <div class="w-full max-w-2xl flex flex-col gap-4">
    ...
    <label class="flex flex-col gap-1">
      ...
      <input bind:value={logoUrl} type="url" placeholder="https://..." class="rounded-xl border border-slate-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-3 py-2" />
    </label>
    ...
    <div class="flex justify-end gap-2 pt-2">
      ...
      <Button on:click={createComun} disabled={creating}>
