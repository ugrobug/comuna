...
<div class="flex flex-col gap-6 max-w-3xl">
  ...
  <ol class="list-decimal pl-6 space-y-2 text-base leading-relaxed">
    ...
    <li>Добавьте нашего бота <a href="https://t.me/aiwapressbot" target="_blank" rel="noreferrer">@aiwapressbot</a> в администраторы канала и дайте права читать/публиковать сообщения.</li>
