...
def rebuild_post_previews_without_media_text(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("feeds", "0120_rebuild_formatted_post_previews"),
    ]

    operations = [
        migrations.RunPython(rebuild_post_previews_without_media_text, migrations.RunPython.noop),
    ]
