...
from editor.views import (
    ...
    draft_access,
    shared_draft_comment_reply,
    shared_draft_comment_thread,
    shared_draft_comments,
    post_poll_vote,
    post_rating_vote,
    shared_draft_detail,
    user_post_update,
...
urlpatterns = [
    ...
    path(
        "api/posts/<int:post_id>/question-answer/",
        question_answer_update,
        name="post-question-answer",
    ),
    path(
        "api/posts/<int:post_id>/event-attendance/",
        event_attendance_update,
        name="post-event-attendance",
    ),
    ...
    path("api/posts/<int:post_id>/report/", post_report, name="post-report"),
    ...
    path("api/comments/<int:comment_id>/report/", comment_report, name="comment-report"),
    ...
    path(
        "api/moderator/content-reports/",
        moderator_content_reports,
        name="moderator-content-reports",
    ),
    path(
        "api/moderator/content-reports/<int:report_id>/",
        moderator_content_report_update,
        name="moderator-content-report-update",
    ),
    path(
    ...
    path(
        "api/auth/drafts/shared/<str:share_token>/comments/",
        shared_draft_comments,
        name="auth-shared-draft-comments",
    ),
    path(
        "api/auth/drafts/shared/<str:share_token>/comments/<int:thread_id>/",
        shared_draft_comment_thread,
        name="auth-shared-draft-comment-thread",
    ),
    path(
        "api/auth/drafts/shared/<str:share_token>/comments/<int:thread_id>/replies/",
        shared_draft_comment_reply,
        name="auth-shared-draft-comment-reply",
    ),
